...
conf_mnist_vae['CUDA'] = True
conf_mnist_vae['lr'] = 10**(-3)
...
conf_mnist_wae_gan['lr'] = 10**(-3)
conf_mnist_wae_gan['B1'] = 0.5
conf_mnist_wae_gan['B2'] = 0.999
conf_mnist_wae_gan['lr_disc'] = 5*10**(-4)
...
conf_celeba_wae_gan['lr'] = 3*10**(-4)
conf_celeba_wae_gan['B1'] = 0.5
conf_celeba_wae_gan['B2'] = 0.999
conf_celeba_wae_gan['lr_disc'] = 10**(-3)
...
conf_celeba_wae_gan['noise'] = True
...
conf_mnist_wae_mmd['sig_z'] = 1
conf_mnist_wae_mmd['lambda'] = 10

#CELEBA-WAE-MMD
conf_celeba_wae_mmd = {}
conf_celeba_wae_mmd['type'] = 'WAEMMD'
conf_celeba_wae_mmd['latentd'] = 64
conf_celeba_wae_mmd['dataset'] = 'celeba'
conf_celeba_wae_mmd['CUDA'] = True
conf_celeba_wae_mmd['lr'] = 10**(-3)
